...
export interface IPastEventsListProps {
  events: IEvent[]
  onEventClick?: (evt: IEvent) => void
  filters?: ((evt: IEvent) => boolean)[]
}

export interface IPastEventsListState {
  sort: ISortableList
  columns: any[]
}
...
export default class PastEventsList extends React.Component<IPastEventsListProps, IPastEventsListState> {
  constructor(props: IPastEventsListProps) {
    super(props)
    this.state = {
      sort: {
        index: 2,
  ...
  //             //this.props.onEventClick(this.props.events[index])
  //             return
  //           }
  //         }
  //       }
