...
export interface IEventPageWebPartProps {
  description: string;
}

export default class EventPageWebPart extends BaseClientSideWebPart<IEventPageWebPartProps> {
  public onInit() {
  ...
  public render(): void {
    const element: React.ReactElement<IEventPageProps> = React.createElement(
      EventPage,
      {
